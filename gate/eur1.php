...
$sk = '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';
$lista = $_GET['lista'];
...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=eur&payment_method_types[]=card&description=Custom Donation&payment_method='.$tok1.'&confirm=true&off_session=true');
