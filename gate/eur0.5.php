...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount=50&currency=eur&payment_method_types[]=card&description=Gunnu Donation&payment_method='.$tok1.'&confirm=true&off_session=true');
